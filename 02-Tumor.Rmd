...
There is an slightly significant effect of the status of the donor, with indivduals grafted with Robusta tissus developing less tumors than healthy one.
And a strong effect of the donor status, with 10,4 % (IRR of 9,62) more chances to developp tumors when the giver is tumorous.
...
simulateResiduals(m8, plot=T) #144.7587 - 146.7587
````

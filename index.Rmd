...
We have chosen to analyze data containing transmitted tumors and data containing spontaneous tumors separately, to avoid model comparisons with missing categories (Rob has no spontaneous tumors, Mt has no transmitted tumors).

Both datasets includes the followings variables : 
...
*tenta_1 à 10* corresponds to the number of thentacles of each individual each week of the post-grafting following period (1 to 10). 
...
*tumor size before freezing* refers to the tumor size before freezing of the individual (if the hydra remains alive throughout the post-grafting follow-up period), see Tissot et all 2023 for an explanation of the scale used 
